...
const LoginPage = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (role === 'student') {
      console.log('Student Login:', { studentId });
    } else {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-r from-[#EBFCFF] to-[#D6F0FF] font-sans">
      {/* Logo and Title */}
